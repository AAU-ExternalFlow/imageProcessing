...
renderView1.CameraPosition = [5.0, 0.0, 110.34910626658501]
renderView1.CameraFocalPoint = [5.0, 0.0, 1.0499999821186066]
renderView1.CameraParallelScale = 19.852126315215518
renderView1.CameraParallelProjection = 1

# save screenshot
SaveScreenshot('D:/Skole/Uni/ExternalFlow/simulation/0/simulation/mesh1.png', renderView1, ImageResolution=[3000, 3000],
