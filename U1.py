...
# set scalar coloring
ColorBy(foamfoamDisplay, ('POINTS', 'U', 'Magnitude'))
...
uLUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 0.8997142980322564, 0.865003, 0.865003, 0.865003, 1.7994285960645129, 0.705882, 0.0156863, 0.14902]
uLUT.UseLogScale = 0
...
uPWF.Points = [0.0, 0.0, 0.5, 0.0, 1.7994285960645129, 1.0, 0.5, 0.0]
...
uLUTColorBar.WindowLocation = 'Lower Right Corner'
uLUTColorBar.Position = [0.89, 0.02]
uLUTColorBar.Title = 'U'
uLUTColorBar.ComponentTitle = 'Magnitude'
uLUTColorBar.TitleJustification = 'Centered'
uLUTColorBar.HorizontalTitle = 0
...
uLUTColorBar.DrawBackground = 0
uLUTColorBar.BackgroundColor = [1.0, 1.0, 1.0, 0.5]
uLUTColorBar.BackgroundPadding = 2.0
uLUTColorBar.DrawScalarBarOutline = 0
uLUTColorBar.ScalarBarOutlineColor = [1.0, 1.0, 1.0]
uLUTColorBar.ScalarBarOutlineThickness = 1
...
uLUTColorBar.UseCustomLabels = 0
uLUTColorBar.CustomLabels = []
uLUTColorBar.AddRangeLabels = 1
uLUTColorBar.RangeLabelFormat = '%-#6.1e'
uLUTColorBar.DrawDataRange = 0
uLUTColorBar.DataRangeLabelFormat = '%-#6.1e'
...
uLUTColorBar.ReverseLegend = 0

# change scalar bar placement
uLUTColorBar.Orientation = 'Horizontal'
uLUTColorBar.WindowLocation = 'Any Location'
uLUTColorBar.Position = [0.32198511166253074, 0.020298507462686854]
uLUTColorBar.ScalarBarLength = 0.3299999999999981
...
=======
renderView1.CameraPosition = [-0.456653811658314, 0.09964633390007102, 110.34910626658501]
renderView1.CameraFocalPoint = [-0.456653811658314, 0.09964633390007102, 1.0499999821186066]
>>>>>>> Stashed changes
renderView1.CameraParallelScale = 0.8774320010325023
renderView1.CameraParallelProjection = 1

# save screenshot
<<<<<<< Updated upstream
SaveScreenshot('D:/Skole/Uni/ExternalFlow/dashWebApp/assets/10/U1.png', renderView1, ImageResolution=[3000, 3000],
=======
SaveScreenshot('D:/Skole/Uni/ExternalFlow/simulation/0/simulation/U1.png', renderView1, ImageResolution=[3000, 3000],
>>>>>>> Stashed changes
...
# current camera placement for renderView1
<<<<<<< Updated upstream
renderView1.CameraPosition = [0, 0.09964633390007102, 110.34910626658501]
renderView1.CameraFocalPoint = [0, 0.09964633390007102, 1.0499999821186066]
=======
renderView1.CameraPosition = [-0.456653811658314, 0.09964633390007102, 110.34910626658501]
renderView1.CameraFocalPoint = [-0.456653811658314, 0.09964633390007102, 1.0499999821186066]
>>>>>>> Stashed changes
