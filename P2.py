...
pLUTColorBar.WindowLocation = 'Lower Right Corner'
pLUTColorBar.Position = [0.89, 0.02]
pLUTColorBar.Title = 'p'
pLUTColorBar.ComponentTitle = ''
pLUTColorBar.TitleJustification = 'Centered'
pLUTColorBar.HorizontalTitle = 0
...
pLUTColorBar.ScalarBarLength = 0.33
pLUTColorBar.DrawBackground = 0
pLUTColorBar.BackgroundColor = [1.0, 1.0, 1.0, 0.5]
pLUTColorBar.BackgroundPadding = 2.0
pLUTColorBar.DrawScalarBarOutline = 0
pLUTColorBar.ScalarBarOutlineColor = [1.0, 1.0, 1.0]
pLUTColorBar.ScalarBarOutlineThickness = 1
...
pLUTColorBar.RangeLabelFormat = '%-#6.1e'
pLUTColorBar.DrawDataRange = 0
pLUTColorBar.DataRangeLabelFormat = '%-#6.1e'
...
pLUTColorBar.ReverseLegend = 0

# change scalar bar placement
pLUTColorBar.Orientation = 'Horizontal'
pLUTColorBar.WindowLocation = 'Any Location'
pLUTColorBar.Position = [0.30771712158808967, 0.019054726368158748]
pLUTColorBar.ScalarBarLength = 0.3299999999999989
...
# save screenshot
<<<<<<< Updated upstream
SaveScreenshot('D:/Skole/Uni/ExternalFlow/dashWebApp/assets/10/P2.png', renderView1, ImageResolution=[3000, 3000],
=======
SaveScreenshot('D:/Skole/Uni/ExternalFlow/simulation/0/simulation/P2.png', renderView1, ImageResolution=[3000, 3000],
>>>>>>> Stashed changes
